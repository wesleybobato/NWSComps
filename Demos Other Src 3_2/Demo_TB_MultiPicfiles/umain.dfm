object MainForm: TMainForm
  ...
  Top = 154
  Caption = 
    'Work with Multi-Tiff, Multi-Gif or Video Files using Thumbs Brow' +
    'ser'
  ClientHeight = 503
  ClientWidth = 853
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 0
    object LabelLoadingstatus: TLabel
      Left = 400
      Top = 0
      Width = 237
      Height = 49
    ...
    object rgpAsync: TRadioGroup
      Left = 637
      Top = 0
      Width = 216
      Height = 49
      Align = alRight
      Caption = 'Async Loading'
      Columns = 2
      ItemIndex = 1
      Items.Strings = (
        'OFF'
  ...
  object TB1: TThumbsBrowser
    ...
    MultiThread = True
    MultiThread_Pool_Count = 6
    MultiThread_Timeout = 3500
    ...
    ThumbsFramePadding_Top = 2
    ThumbsFramePadding_Bottom = 2
    ThumbsSpacing = 4
    ThumbsSpacingX = 4
    ThumbsSpacingY = 4
    ...
    ShowCaptions = True
    ThumbCaption_Settings = [cap_ShowDimensions, cap_General, cap_Other1]
    ...
    SortType = stNotSorted
    OnThumbBufferLoaded = TB1ThumbBufferLoaded
    OnThumbLoadDemandAsync = TB1ThumbLoadDemandAsync
    OnThumbLoaded = TB1ThumbLoaded
    OnProgress = TB1Progress
    OnStartedLoading = TB1StartedLoading
  ...
  object Panel2: TPanel
    ...
    object btnDeleteRec: TBitBtn
      Left = 443
      Top = 9
      Width = 137
      Height = 25
      Caption = 'Delete Frame(s)'
      TabOrder = 0
    ...
    object btnInsertRecord: TBitBtn
      ...
      Width = 137
      Height = 25
      Caption = 'Insert Frame(s)'
      TabOrder = 1
      OnClick = btnInsertRecordClick
    end
    object rgpWantOrigSize: TRadioGroup
      Left = 162
      Top = 0
      Width = 120
      Height = 41
      Align = alLeft
      Caption = 'Want Original Size'
      Columns = 2
      ItemIndex = 0
      Items.Strings = (
        'NO'
